      ...
      <div className="flex flex-row items-center mx-6 mt-1 space-x-1">
        ...
        <div className="w-2 h-2 rounded-full border-2">
          <a href="https://www.amazon.com/" target="blank">
            <Image src="/amazon.png" alt="Amazon" title="Amazon" width={300} height={100}/>
          </a>        
        </div>
        <div className="timeline-mid"/>
        <div className="w-2 h-2 rounded-full border-2">
          <a href="https://www.geotab.com/" target="blank">
            <Image src="/geotab.png" alt="Geotab" title="Geotab" width={300} height={100}/>
          </a>        
        </div>
        <div className="timeline-mid"/>
        <div className="w-2 h-2 rounded-full border-2">
          <a href="https://www.ansys.com/" target="blank">
            <Image src="/ansys.png" alt="Ansys" title="Ansys" width={300} height={100}/>
          </a>
        </div>
