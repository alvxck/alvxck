    ...
    <main className="bg-topography flex min-h-screen flex-col items-center justify-center">
      <div className="flex flex-col items-center w-full space-y-5">
        <div className="lg:w-1/2 sm:w-full flex flex-row space-x-7">
          ...
          <div className="flex grow items-center space-x-3">
            <a id="linkedin" className="medialink" href="https://www.linkedin.com/in/alvx/" target="blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><title>LinkedIn</title><path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path></svg>
            </a>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -50 512 512"><title>Email</title><path d="M121 32C91.6 32 66 52 58.9 80.5L1.9 308.4C.6 313.5 0 318.7 0 323.9V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V323.9c0-5.2-.6-10.4-1.9-15.5l-57-227.9C446 52 420.4 32 391 32H121zm0 64H391l48 192H387.8c-12.1 0-23.2 6.8-28.6 17.7l-14.3 28.6c-5.4 10.8-16.5 17.7-28.6 17.7H195.8c-12.1 0-23.2-6.8-28.6-17.7l-14.3-28.6c-5.4-10.8-16.5-17.7-28.6-17.7H73L121 96z"/></svg>
            </a>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 sm:w-full">
          ...
          <p className="text-sm px-6">I specialize in XXX and web development.</p>
